    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-sm text-white/80 mb-6">
          ...
          <span className="mx-2">›</span>
          <span className="text-white">{t("ac_construction")}</span>
        </div>
        ...
        <div className="bg-black rounded-2xl shadow-xl p-6 mb-8">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
            <Link href="/application-cases/construction-engineering" className="px-4 py-2 text-sm text-black bg-white rounded-lg font-semibold">
              {t("ac_construction")}
            </Link>
        ...
        <section className="bg-gray-800 rounded-2xl shadow-xl p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-white">{t("ac_construction")}</h2>
          </div>
          
          <div className="space-y-3 mb-8 bg-black rounded-lg p-6">
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">{t("ac_construction_li1")}</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">{t("ac_construction_li2")}</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">{t("ac_construction_li3")}</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">{t("ac_construction_li4")}</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">{t("ac_construction_li5")}</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">{t("ac_construction_li6")}</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">{t("ac_construction_li7")}</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">{t("ac_construction_li8")}</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">{t("ac_construction_li9")}</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">{t("ac_construction_li10")}</p>
            </div>
          </div>
          ...
          <div className="mb-8 rounded-lg border border-white/20 bg-white/5 p-6">
            ...
            <p className="text-white/90 leading-relaxed">{t("ac_construction_details")}</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="relative w-full h-64 bg-gray-100 rounded-lg overflow-hidden">
                <Image
                  ...
                  alt="Construction & Engineering Project 1"
                  fill
                  unoptimized
              ...
              <div className="relative w-full h-64 bg-gray-100 rounded-lg overflow-hidden">
                <Image
                src="/const2.jpg"
                  alt="Construction & Engineering Project 2"
                  fill
                  unoptimized
                  className="object-cover"
                />
              ...
              <div className="relative w-full h-64 bg-gray-100 rounded-lg overflow-hidden">
                <Image
                                src="/const1.jpg"
                  alt="Construction & Engineering Project 3"
                  fill
                  unoptimized
                  className="object-cover"
                />
